...
class StatisticsService:
    ...
    async def record_decision_stats(self, tenant_id: str, state: DecisionState, duration_ms: float):
        """
    ...
    async def record_policy_stats(self, policy_id: str, duration_ms: float, was_overridden: bool):
        """
